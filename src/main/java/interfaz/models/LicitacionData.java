...
/**
 * Clase inmutable que almacena los datos de configuración esenciales de una licitación,
 * incluyendo el expediente, el objeto, si tiene lotes y la lista de archivos
 * comunes y documentos de oferta requeridos.
 *
 * Implementa {@link Serializable} para permitir el guardado y la carga de la configuración.
 *
 * NOTA: Esta clase depende de {@link ArchivoRequerido}, la cual se asume definida
 * en algún lugar del proyecto.
 */
public class LicitacionData implements Serializable {
     ...
     * @param tieneLotes {@code true} si la licitación está dividida en lotes; {@code false} en caso contrario.
     * @param numLotes El número total de lotes, o 1 si no tiene lotes.
     * @param archivosComunes Un array con la configuración de los archivos comunes requeridos.
     * @param documentosOferta Un array con la configuración de los documentos de oferta requeridos
     * (por ejemplo, oferta económica, técnica).
     */
    public LicitacionData(String expediente, String objeto, boolean tieneLotes,
                          int numLotes, ArchivoRequerido[] archivosComunes,
                          ArchivoRequerido[] documentosOferta) {
     ...
     */
    public boolean tieneLotes() { return tieneLotes; }

    /**
     * Obtiene el número total de lotes.
     * @return El número de lotes (mayor o igual a 1).
     */
    public int getNumLotes() { return numLotes; }

    /**
     * Obtiene el array de archivos comunes requeridos para la licitación.
     * @return Un array de objetos {@code ArchivoRequerido}.
     */
    public ArchivoRequerido[] getArchivosComunes() { return archivosComunes; }

    /**
     * Obtiene el array de documentos de oferta requeridos para la licitación.
     * @return Un array de objetos {@code ArchivoRequerido}.
     */
    public ArchivoRequerido[] getDocumentosOferta() { return documentosOferta; }

    /**
     * Devuelve una representación en cadena de texto de esta instancia de {@code LicitacionData},
